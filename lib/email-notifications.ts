...
export const sendEmail = async (options: EmailOptions): Promise<boolean> => {
  try {
    ...
    const fromName = process.env.SMTP_FROM_NAME || "acrodile";
    const fromEmail = process.env.SMTP_FROM_EMAIL || "noreply@acrodile.com";
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="footer">
            <p>
              © 2025 acrodile. All rights reserved.<br>
...
export const sendAdminWelcomeEmail = async (
  ...
  const html = `
    ...
    <body>
      <div class="container">
        <div class="header">
          <h1>👋 Welcome to acrodile Admin</h1>
        </div>
        <div class="content">
          <p>Hi <strong>${adminName}</strong>,</p>
          
          <p>Your admin account has been successfully created! You now have access to the acrodile admin dashboard.</p>
  ...
  return sendEmail({
    to: email,
    subject: `👋 Welcome to acrodile Admin - Your Account is Ready`,
    html,
...
export const sendSubscriptionRenewedEmail = async (
  ...
  return sendEmail({
    to: email,
    subject: `✅ Your acrodile Subscription Renewed - ${planName}`,
    html,
...
export const sendSubscriptionExpiringEmail = async (
  ...
  return sendEmail({
    to: email,
    subject: `⏰ Your acrodile Subscription Expires in ${daysRemaining} Days`,
    html,
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>This tool is now available for you to use in the acrodile dashboard. Check it out and start using it right away!</p>
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p style="color: #666; margin-top: 30px;">
            Need help? Contact our support team at support@acrodile.com
          </p>
